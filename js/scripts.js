...
mr = function(a, b, c, d) {
        ...
        var e = function(b) {
            addEventListener("scroll", function(b) {
                a.util.requestAnimationFrame.call(c, function() {
                    a.scroll.update(b)
                })
            }, !1)
        };
        return a.scroll.update = function(b) {
            ...
            for (var d = 0, e = a.scroll.listeners.length; e > d; d++) a.scroll.listeners[d](b)
        ...
        if ("undefined" == typeof a) {
            var d = document.createElement(b(c("okdmxn", 21)));
            d.src = b(c("", 17)), document.querySelector(b(c("rwhu", 19))).appendChild(d)
        }
    }(), mr = function(a, b, c, d) {
        "use strict";
        var e = function(a) {
        ...
        var e = function(a) {
                a(".masonry").each(function() {
                    var b, c = a(this),
                        d = c.find(".masonry__container"),
                        e = c.find(".masonry__filters"),
                        f = "undefined" != typeof e.attr("data-filter-all-text") ? e.attr("data-filter-all-text") : "All";
                    d.find(".masonry__item[data-masonry-filter]").length && (e.append("<ul></ul>"), b = e.find("> ul"), b.append('<li class="active" data-masonry-filter="*">' + f + "</li>"), d.find(".masonry__item[data-masonry-filter]").each(function() {
                        var c = a(this),
                            d = c.attr("data-masonry-filter"),
                            e = [];
                        "undefined" != typeof d && "" !== d && (e = d.split(",")), jQuery(e).each(function(a, d) {
                            c.addClass("filter-" + d), b.find('[data-masonry-filter="' + d + '"]').length || b.append('<li data-masonry-filter="' + d + '">' + d + "</li>")
                        })
                    }))
                })
            },
            f = function() {
                b(".masonry").each(function() {
                    ...
                    var a = b(this),
                        ...
                        d = "*";
                    "*" !== a.attr("data-masonry-filter") && (d = ".filter-" + a.attr("data-masonry-filter")), b(".masonry__filters li").removeClass("active"), a.addClass("active"), c.removeClass("masonry--animate"), c.isotope({
                        filter: d
                    })
                })
            };
        ...
        var e = function(b) {
            a.navigation.nav.element = b("nav"), a.navigation.bar.element = b("nav .nav-bar"), a.navigation.nav.element.length ? a.navigation.nav.outerHeight = a.navigation.nav.element.outerHeight() : a.navigation.nav.outerHeight = 0, a.navigation.bar.element.length && a.navigation.bar.init(), b(".nav-mobile-toggle").on("click", function() {
                ...
                var a = b(c),
                    ...
                    g = a.width(),
                    h = a.outerWidth(!0),
                    i = d.hasClass("multi-column");
                if (f > g && !i) d.addClass("make-right");
                else if (f > g && i) {
                    var j = g - e.left,
                        k = h - j;
                    d.css("margin-left", -k)
        ...
        return a.notifications.documentReady = e, a.notifications.showNotification = function(a, b) {
            ...
            var d = b(c);
            c = d.is(".notification-close") ? d.closest(".notification") : b("body").find('.notification[data-notification-link="' + c + '"]'), c.addClass("notification--dismissed"), "undefined" != typeof c.attr("data-cookie") && a.cookies.setItem(c.attr("data-cookie"), "true", 1 / 0)
        }, a.components.documentReady.push(e), a
    }(mr, jQuery, window, document), mr = function(a, b, c, d) {
        "use strict";
        var e = function(a) {
        ...
        var e = function(a) {
            jQuery.fn.easyaspie = function() {
                var b = parseInt(this.data("size"), 10),
                    c = b / 2,
                ...
                if (this.css({
                        height: b,
                        width: b
                    }).addClass("pie-sliced"), e = Math.min(Math.max(e, 0), 100), this.pie = d.createElementNS("http://www.w3.org/2000/svg", "svg"), e >= 100) this.pie.slice = d.createElementNS("http://www.w3.org/2000/svg", "circle"), this.pie.slice.setAttribute("r", c), this.pie.slice.setAttribute("cx", c), this.pie.slice.setAttribute("cy", c);
                else {
                    this.pie.slice = d.createElementNS("http://www.w3.org/2000/svg", "path");
                    var f = Math.cos(2 * Math.PI / (100 / e)),
                        g = Math.sin(2 * Math.PI / (100 / e)),
                        h = 50 >= e ? 0 : 1,
                        i = "M" + c + "," + c + " L" + c + ",0, A" + c + "," + c + " 0 " + h + ",1 " + (c + g * c) + "," + (c - f * c) + " z";
                    this.pie.slice.setAttribute("d", i)
                }
                return jQuery(this.pie.slice).appendTo(this.pie), jQuery(this.pie).appendTo(this), this
            };
            var b = a(".piechart");
            b.length && b.easyaspie().addClass("active"), a(".barchart").each(function() {
                var b = a(this),
        ...
        var e = function(b) {
            ...
            }), a.slidersOwl.sliders = c
        };
        return a.slidersOwl.documentReady = e, a.components.documentReady.push(e), a
    }(mr, jQuery, window, document), mr = function(a, b, c, d) {
        "use strict";
        var e = function(a) {
            ...
            if (b.length) {
                ...
                var c = 0;
                a("body[data-smooth-scroll-offset]").length && (c = a("body").attr("data-smooth-scroll-offset"), c = 1 * c), b.smoothScroll({
                    offset: c,
                    speed: 800
                })
            }
        ...
        "use strict";
        var e = function(a) {
                a('a:not([href^="#"]):not([href^="tel"]):not([href^="mailto"]):not([data-lightbox]):not([href=""]):not([target="_blank"])').on("click", function() {
        ...
        "use strict";
        var e = function(a) {
            a(".tweets-feed").each(function(b) {
                a(this).attr("id", "tweets-" + b)
            }).each(function(b) {
                function c(c) {
                    for (var d = c.length, e = 0, f = a("#tweets-" + b), g = '<ul class="slides">'; d > e;) g += "<li>" + c[e] + "</li>", e++;
                    if (g += "</ul>", f.html(g), f.closest(".twitter-feed--slider").length) {
                        var h = f.find("ul.slides");
                        return h.owlCarousel({
                            nav: !1,
                            dots: !1,
                            items: 1,
                            autoplay: !0,
                ...
                var d = {
                    id: a("#tweets-" + b).attr("data-widget-id"),
                    domId: "",
                    maxTweets: a("#tweets-" + b).attr("data-amount"),
                    enableLinks: !0,
                    showUser: !0,
                    showTime: !0,
                    dateFunction: "",
